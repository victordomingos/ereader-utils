...
-- Exampple: credentials={url="https://secure.lemonde.fr/sfuser/connexion", auth={email="titi@gmouil.com", password="xxxx"}}
 ...
 -- LIST YOUR FEEDS HERE:
  { "https://github.com/crosspoint-reader/crosspoint-reader/releases.atom", limit = 3, download_full_article=true, include_images=true },
  { "https://github.com/koreader/koreader/releases.atom", limit = 3, download_full_article=true, include_images=true, enable_filter=true, filter_element = "div.release-main-section", block_element = ""},
 ...
 -- ===============================
  ...
  { "https://www.rtp.pt/noticias/rss", limit = 20, download_full_article=true, include_images=true },
  { "https://feeds.feedburner.com/PublicoRSS", limit = 20, download_full_article=true, include_images=true },
  { "https://jornaleconomico.sapo.pt/feed", limit = 20, download_full_article=true, include_images=true },
  ...
  { "https://appleinsider.com/rss/news", limit = 20, download_full_article=true, include_images=true, enable_filter=true, filter_element=".articleBody", filtrar_promocoes=true },
  { "https://feeds.macrumors.com/MacRumors-All", limit = 10, download_full_article=true, include_images=true, filtrar_promocoes=true },
  { "https://arstechnica.com/information-technology/feed", limit = 20, download_full_article=true, include_images=true },
  ...
  { "https://devblogs.microsoft.com/dotnet/feed/", limit = 20, download_full_article=true, include_images=true },
  { "https://feed.infoq.com/dotnet", limit = 20, download_full_article=true, include_images=true },
  { "https://feed.infoq.com/development", limit = 20, download_full_article=true, include_images=true },


  -- ===============================
  -- 🔓 Open Source
  -- ===============================
  { "https://www.haiku-os.org/index.xml", limit = 5, download_full_article=true, include_images=true },
  { "https://www.haiku-os.org/blog/index.xml", limit = 5, download_full_article=true, include_images=true },
  { "https://www.desktoponfire.com/feed/", limit = 5, download_full_article=true, include_images=true },
  { "https://blog.python.org/feeds/posts/default", limit = 4, download_full_article=true, include_images=true },
  ...
  { "https://meshtastic.org/blog/rss.xml", limit = 6, download_full_article=true, include_images=true },
